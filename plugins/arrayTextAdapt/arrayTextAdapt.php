 ...
 */
class arrayTextAdapt  extends PluginBase { // \LimeSurvey\PluginManager\PluginBase {
    ...
    public function init()
    {
        ...
        $this->subscribe('beforeTwigRenderTemplate', 'beforeQuestionRender');
    }

    public function beforeSurveySettings()
    {
		error_log("beforeSurveySettings() called.");
        $event = $this->event;
        $aSettings=array();
    ...
    public function beforeQuestionRender()
    {
		...
		error_log("beforeQuestionRender() called with... " . $this->getEvent()->get('type'));
